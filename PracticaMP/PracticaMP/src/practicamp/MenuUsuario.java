...
public class MenuUsuario extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cerrarCuenta.setText("Dar de baja la cuenta");
        ...
        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {btnConultarOro, btnCrearPersonaje, btnDarBajaPersonaje, btnDesafiar, btnElegirArmaduras, btnElegirArmas, btnHistorial, btnNotificaciones, btnRanking, btnSalir});
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(60, 60, 60)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(btnHistorial, javax.swing.GroupLayout.DEFAULT_SIZE, 47, Short.MAX_VALUE)
        ...
        layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {btnConultarOro, btnCrearPersonaje, btnDarBajaPersonaje, btnDesafiar, btnElegirArmaduras, btnElegirArmas, btnHistorial, btnNotificaciones, btnRanking, btnSalir});

    }// </editor-fold>//GEN-END:initComponents

    private void btnDesafiarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDesafiarActionPerformed
        boolean tienesNotificaciones = !Almacen.getUsuarioActivo().getNotificaciones().isEmpty();
        boolean tienesArmas = !Almacen.getUsuarioActivo().getArmasActivas().isEmpty();
        boolean tienesArmadura = Almacen.getUsuarioActivo().getArmaduraActiva() != null;
        if (!tienesNotificaciones && tienesArmas && tienesArmadura){
            ...
            JOptionPane.showMessageDialog(null, "No puedes acceder a esto hasta que no tengas un arma equipada", "No tienes un arma equipada", JOptionPane.INFORMATION_MESSAGE);// TODO add your handling code here:
        } else if (!tienesArmadura) {
            JOptionPane.showMessageDialog(null, "No puedes acceder a esto hasta que no tengas un armadura equipada", "No tienes un armadura equipada", JOptionPane.INFORMATION_MESSAGE);// TODO add your handling code here:
        }
    ...
    private void btnHistorialActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHistorialActionPerformed
        boolean tienesNotificaciones = !Almacen.getUsuarioActivo().getNotificaciones().isEmpty();
        boolean tienesCombates = !Almacen.getUsuarioActivo().getHistorial().isEmpty();
        if (!tienesNotificaciones && tienesCombates){
            JPanel parent = (JPanel) getParent();
            CardLayout cl = (CardLayout) parent.getLayout();
            cl.invalidateLayout(parent);
            cl.show(parent, "pantallaHistorial");
        } else if (tienesNotificaciones){
            JOptionPane.showMessageDialog(null, "No puedes acceder a esto hasta que vacies tus notificaciones", "Tienes notificaciones", JOptionPane.INFORMATION_MESSAGE);// TODO add your handling code here:
        } else if (!tienesCombates){
            JOptionPane.showMessageDialog(null, "No tienes ningún combate en tu historial", "Esta vacion el historial", JOptionPane.INFORMATION_MESSAGE);// TODO add your handling code here:
        }
